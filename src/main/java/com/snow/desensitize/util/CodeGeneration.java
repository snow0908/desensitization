...
public class CodeGeneration {
    ...
    public static void main(String[] args) {
        ...
        String[] Include = { "tb_user_copy"};// 生成的表
...
//                .entityTableFieldAnnotationEnable(true)
        ...
        pkConfig.setParent("com.snow.desensitize")
                .setMapper("dao.usertest")// dao
                .setService("service.usertest")// servcie
                .setServiceImpl("service.impl.usertest")
                .setController("controller.usertest")// controller
                .setEntity("entity.usertest")
                .setXml("dao.mapping.usertest");// mapper.xml
